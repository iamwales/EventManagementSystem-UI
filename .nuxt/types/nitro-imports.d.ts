declare global {
  const GqlCreateEventStart: typeof import('#gql-nitro')['GqlCreateEventStart']
  const GqlFindAllEvents: typeof import('#gql-nitro')['GqlFindAllEvents']
  const GqlFindEventByUuid: typeof import('#gql-nitro')['GqlFindEventByUuid']
  const GqlLogin: typeof import('#gql-nitro')['GqlLogin']
  const GqlRegister: typeof import('#gql-nitro')['GqlRegister']
...
export { GqlCreateEventStart, GqlFindAllEvents, GqlFindEventByUuid, GqlLogin, GqlRegister } from '#gql-nitro';
